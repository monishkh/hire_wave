            ...
            <Dialog open={open}>
                <DialogContent className="sm:max-w-[425px] bg-white" onInteractOutside={() => setOpen(false)}>
                    ...
                    <form onSubmit={handleSubmit} >
                        ...
                        <DialogFooter>
                            {
                                loading ? <Button className="w-full my-4 bg-blue-500 text-white hover:bg-blue-600 "> <Loader2 className='mr-2 h-4 w-4 animate-spin' /> Please wait </Button> : <Button type="submit"
                                    className="w-full my-4 bg-blue-500 hover:bg-blue-600 text-white">Update</Button>
                            }
                        </DialogFooter>
                    </form>
                </DialogContent>
